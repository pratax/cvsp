...
public class PrePostProcessor {
    ...
    private static int mOutputRow = 6300; //yolov7 6300 //25200; // as decided by the YOLOv5 model for input image of size 640*640
    private static int mOutputColumn = 21; // left, top, right, bottom, score and 80 class probability
    ...
    static ArrayList<Result> outputsToNMSPredictions(float[] outputs, float imgScaleX, float imgScaleY, float ivScaleX, float ivScaleY, float startX, float startY) {
        ...
        for (int i = 0; i< mOutputRow; i++) {
            if (outputs[i* mOutputColumn +4] > mThreshold) {
                ...
                /*System.out.println(startX+ivScaleX*left);
                System.out.println(startY+top*ivScaleY);
                System.out.println(startX+ivScaleX*right);
                System.out.println(startY+ivScaleY*bottom);*/
            ...
            /*Rect rect = new Rect(270, 150, 900, 650);
            Result result = new Result(2, (float)1.0, rect);
            results.add(result);*/
        }
