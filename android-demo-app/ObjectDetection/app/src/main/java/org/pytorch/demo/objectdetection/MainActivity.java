...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"test5.JPG", "test3.jpeg", "test6.JPG"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInferenceText = findViewById(R.id.textView);
        mButtonDetect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                thread.start();
                mInferenceText.setText(String.format("Inference Time: %,.2f s", timeElapsed));
            }
        });
    ...
    public void run() {
        ...
        timeElapsed = (double)Duration.between(start, end).toMillis()/1000;
        System.out.println(timeElapsed);
        String time = ""+timeElapsed;
        final Tensor outputTensor = outputTuple[0].toTensor();
        System.out.println(Arrays.toString(outputTensor.shape()));

        /*Tensor[] outputList = mModule.forward(IValue.from(inputTensor)).toTensorList();
        final Tensor outputTensor = outputList[0];
        System.out.println(Arrays.toString(outputTensor.shape()));*/
